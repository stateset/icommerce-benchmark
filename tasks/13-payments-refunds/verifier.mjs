...
const expected = {
  ...
  paymentCount: 1,
  earlyRefundRejectionCode: 'VALIDATION',
  completedStatus: 'completed',
  refundStatus: 'pending',
  refundAmount: '12.50',
  refundReplaySameId: true,
  overRefundRejectionCode: 'VALIDATION',
  storedPaymentStatus: 'completed',
...
try {
  ...
  console.log('PASS 13-payments-refunds');
} catch (error) {
  console.error(`FAIL 13-payments-refunds: ${error.message}`);
  process.exitCode = 1;
}
