...
const expected = {
  ...
  completedResolution: 'replacement',
  orderCount: 0,
  shipmentCount: 0,
  deniedStatus: 'denied',
  deniedResolution: 'denied',
  approveDeniedRejectionCode: 'CONFLICT',
};
...
try {
  ...
  console.log('PASS 12-warranties');
} catch (error) {
  console.error(`FAIL 12-warranties: ${error.message}`);
  process.exitCode = 1;
}
