...
const expected = {
  ...
  initialStatus: 'draft',
  poTotal: '50',
  sendDraftRejectionCode: 'CONFLICT',
  afterFailedSend: 'draft',
  submittedStatus: 'pending_approval',
  approvedStatus: 'approved',
  sentStatus: 'sent',
  finalTotal: '50',
  submitCancelledRejectionCode: 'CONFLICT',
...
try {
  ...
  console.log('PASS 07-supplier-po');
} catch (error) {
  console.error(`FAIL 07-supplier-po: ${error.message}`);
  process.exitCode = 1;
}
