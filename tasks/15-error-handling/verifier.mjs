...
const expected = {
  oversizedKind: 'out_of_stock',
  oversizedAvailable: '2',
  stockAfterReject: ['2', '0', '2'],
  holdKind: 'reserved',
  hasReservationId: true,
  afterReleaseAvailable: '2',
...
try {
  ...
  console.log('PASS 15-error-handling');
} catch (error) {
  console.error(`FAIL 15-error-handling: ${error.message}`);
  process.exitCode = 1;
}
