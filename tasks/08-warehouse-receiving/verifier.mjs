...
const expected = {
  ...
  partialStatus: 'partially_received',
  partialReceived: '4',
  excessRejectionCode: 'VALIDATION',
  afterRejectReceived: '4',
...
try {
  ...
  console.log('PASS 08-warehouse-receiving');
} catch (error) {
  console.error(`FAIL 08-warehouse-receiving: ${error.message}`);
  process.exitCode = 1;
}
